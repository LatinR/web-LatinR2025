...
O Epiverso é uma iniciativa colaborativa global liderada pela data.org, que tem como objetivo desenvolver um ecossistema confiável de análise de dados dedicado a se antecipar à próxima crise de saúde pública. Por meio do desenvolvimento de ferramentas analíticas de alta qualidade, de código aberto e transparentes, e da criação de uma comunidade de usuários.
